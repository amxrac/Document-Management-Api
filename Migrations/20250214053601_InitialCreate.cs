        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DocumentMetadataId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentContent_DocumentMetadata_DocumentMetadataId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentTags_DocumentMetadata_DocumentMetadataId",
                        column: x => x.DocumentMetadataId,
                        principalTable: "DocumentMetadata",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentContent_DocumentMetadataId",
                table: "DocumentContent",
                column: "DocumentMetadataId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DocumentTags_DocumentMetadataId",
                table: "DocumentTags",
                column: "DocumentMetadataId");
